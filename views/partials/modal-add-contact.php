<dialog id="add_contact_modal" class="modal">
  <div class="modal-box p-[12px] bg-background-primary rounded-2xl max-w-[321px] w-full relative z-10">
    ...
    <form action="/contatos/store" method="POST" id="add_contact_form" enctype="multipart/form-data">
      <div class="flex flex-col px-[16px]">
        <div class="p-[20px] flex flex-col items-center justify-center">
          <div
            ...
            <img src="" alt="" id="add_preview" class="w-full h-full object-cover hidden">
            <span id="add_icon" class="material-symbols-rounded text-4xl text-content-muted">account_circle</span>
          </div>
          <input type="file" name="image" id="add_image_input" class="hidden" accept="image/*" onchange="updateImagePreview(this, 'add_preview', 'add_icon')">
      ...
      <div class="flex justify-end pt-[12px] mr-[12px] gap-[12px]">
        <button type="button" onclick="document.getElementById('add_contact_modal').close()"
